# HoGS2020 — Theme for the Hobart Games Society
A copy of the Tendency 2020 Theme which is the base starter theme Tendenci provide for new sites. 

That theme is overly rich with a great deal more on it than HoGS needs so paring it down some to a slightly simple version. 
...
When updating the css in your site be mindful that these classes are implemented frequently in this base-theme. 
Changes to the classes associated will be site-wide!
* Panels
* Navs
* Wells
* Buttons
...
## Features
### Masonry
This theme also uses Masonry in the Photos and Videos modules.
It can be easily applied anywhere else there are variable sized grids.
